...
<style>
  ...
  .mini-menu { width: 222px; max-width: 100%; height: 162px; border: 1px solid rgb(255 255 255 / 90%); border-radius: var(--radius-lg); background: linear-gradient(135deg, rgb(255 255 255 / 70%), rgb(255 255 255 / 30%)); box-shadow: 0 5px 14px -5px rgb(24 42 72 / 18%); color: var(--ink-2); }
  ...
  .primary { background: rgb(255 255 255 / 80%); border-color: white; color: var(--action-dark); transition: box-shadow 160ms ease; }
  ...
  .simple .operation[data-operation='joins'], .simple .operation[data-operation='columns'], .simple .operation[data-operation='dedupe'] { grid-row: 2; background: rgb(255 255 255 / 40%); border-color: rgb(255 255 255 / 60%); }
