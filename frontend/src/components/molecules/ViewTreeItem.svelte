<script lang="ts">
  ...
  let { name, sourceName, versionLabel, active, onselect }: Props = $props();
</script>

<button type="button" class="row" class:active aria-current={active ? 'page' : undefined} onclick={onselect}>
  <span class="details">
